...
async function run() {
  ...
  try {
    ...
    // =============================================
    console.log('\n--- Seeding PRODUCTS ---');
    await client.query("DELETE FROM products WHERE slug LIKE 'vrc-%'");
    ...
    await client.query(`
      ...
      (
        ...
        'https://images.unsplash.com/photo-1631545806609-13e22e tried?w=800',
    ...
    // =============================================
    console.log('\n--- Seeding NEWS ---');
    await client.query("DELETE FROM news WHERE slug LIKE 'vrc-%'");
    ...
    await client.query(`
      ...
      VALUES
      (
        'VRC hoàn thành dự án hệ thống lạnh cho Vinamilk Factory',
        'vrc-hoan-thanh-du-an-vinamilk',
        'Tổng công ty VRC vừa hoàn thành lắp đặt hệ thống điều hòa trung tâm và kho lạnh cho nhà máy Vinamilk tại Bình Dương.',
        '<h2>Dự án tiêu biểu của VRC trong năm 2024</h2><p>VRC đã hoàn thành việc lắp đặt toàn bộ hệ thống điều hòa trung tâm và kho lạnh bảo quản sản phẩm cho nhà máy Vinamilk tại KCN VSIP II, Bình Dương. Đây là một trong những dự án lớn nhất mà VRC thực hiện trong năm 2024.</p><p>Hệ thống bao gồm 2 chiller giải nhiệt nước với tổng công suất 1000 RT, hệ thống AHU cho khu vực sản xuất và 3 kho lạnh bảo quản sản phẩm ở các mức nhiệt độ khác nhau.</p>',
      ...
      (
        ...
        'vrc-xu-huong-cong-nghe-2025',
        'Các xu hướng công nghệ mới trong ngành HVAC năm 2025: AI, IoT, và giải pháp xanh.',
        '<h2>Công nghệ HVAC thế hệ mới</h2><p>Năm 2025 đánh dấu bước ngoặt lớn của ngành HVAC với sự tích hợp sâu của trí tuệ nhân tạo (AI) và Internet of Things (IoT). Các hệ thống điều hòa thông minh có khả năng tự học hành vi sử dụng và tối ưu hóa hiệu suất năng lượng.</p><p>VRC là một trong những đơn vị tiên phong trong việc áp dụng các công nghệ này vào các giải pháp cho khách hàng.</p>',
      ...
      (
        'VRC nhận giải thưởng Doanh nghiệp Xanh 2024',
        'vrc-giai-thuong-doanh-nghiep-xanh-2024',
        'VRC vinh dự nhận giải thưởng Doanh nghiệp Xanh 2024 vì những đóng góp trong lĩnh vực tiết kiệm năng lượng.',
        '<h2>Giải thưởng uy tín cho doanh nghiệp bền vững</h2><p>Ngày 15/11/2024, tại Hà Nội, VRC vinh dự nhận giải thưởng "Doanh nghiệp Xanh 2024" do Bộ Tài nguyên và Môi trường trao tặng. Giải thưởng ghi nhận những nỗ lực không ngừng của VRC trong việc cung cấp các giải pháp điện lạnh thân thiện với môi trường và tiết kiệm năng lượng.</p>',
        'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800',
        NOW() - INTERVAL '20 days',
        'Ban truyền thông VRC',
        $1, ARRAY['giải thưởng', 'xanh', 'bền vững'], 890
      ),
      (
        'Hướng dẫn bảo trì hệ thống điều hòa mùa hè',
        'vrc-huong-dan-bao-tri-mua-he',
        'Những lưu ý quan trọng để bảo trì hệ thống điều hòa trước mùa hè, giúp tiết kiệm điện và tăng tuổi thọ thiết bị.',
        '<h2>Bảo trì đúng cách - Tiết kiệm hơn 20% điện năng</h2><p>Mùa hè đến, nhu cầu sử dụng điều hòa tăng cao. Việc bảo trì định kỳ sẽ giúp hệ thống vận hành hiệu quả hơn, tiết kiệm đến 20% điện năng tiêu thụ.</p><p>VRC khuyến nghị thực hiện các bước bảo trì: Vệ sinh lưới lọc 2 tuần/lần, kiểm tra gas 6 tháng/lần, vệ sinh dàn nóng 3 tháng/lần...</p>',
      ...
      (
        'VRC mở rộng chi nhánh tại Đà Nẵng',
        'vrc-mo-rong-chi-nhanh-da-nang',
        'VRC chính thức khai trương chi nhánh mới tại Đà Nẵng, phục vụ khách hàng khu vực miền Trung.',
        '<h2>Mở rộng mạng lưới phục vụ toàn quốc</h2><p>Ngày 01/10/2024, VRC chính thức khai trương chi nhánh mới tại 123 Nguyễn Văn Linh, Quận Hải Châu, TP. Đà Nẵng. Đây là bước đi quan trọng trong chiến lược mở rộng mạng lưới toàn quốc của VRC, nhằm phục vụ tốt hơn khách hàng khu vực miền Trung - Tây Nguyên.</p>',
    ...
    // =============================================
    console.log('\n--- Seeding PROJECTS ---');
    await client.query("DELETE FROM projects WHERE slug LIKE 'vrc-%'");
    ...
    await client.query(`
      ...
      (
        ...
        'vrc-vissan-cold-storage',
        'Xây dựng hệ thống kho lạnh 5000m² cho Công ty Vissan tại Bình Dương với nhiệt độ bảo quản từ -25°C đến +5°C.',
        '<p>VRC thiết kế và thi công hệ thống kho lạnh bảo quản thực phẩm với tổng diện tích 5000m², bao gồm khu vực đông lạnh (-25°C), kho mát (+5°C) và khu vực xử lý nguyên liệu. Hệ thống đạt chuẩn HACCP và GMP quốc tế.</p>',
      ...
      (
        ...
        'vrc-aeon-mall-ha-dong',
        'Cung cấp và lắp đặt hệ thống điều hòa trung tâm cho TTTM Aeon Mall Hà Đông với tổng diện tích sàn 100,000m².',
        '<p>Dự án lắp đặt hệ thống điều hòa trung tâm cho toàn bộ khu trung tâm thương mại Aeon Mall Hà Đông. Hệ thống bao gồm 4 chiller giải nhiệt nước với tổng công suất 4000 RT, hệ thống AHU, FCU và hệ thống BMS giám sát tự động toàn bộ.</p>',
      ...
      (
        ...
        'vrc-vinmec-hospital',
        'Lắp đặt hệ thống HVAC và phòng sạch cho khoa Phẫu thuật và ICU tại Bệnh viện Vinmec Central Park, TP.HCM.',
        '<p>VRC thực hiện lắp đặt hệ thống HVAC chuyên dụng cho bệnh viện, bao gồm hệ thống xử lý không khí cho 12 phòng phẫu thuật đạt chuẩn ISO Class 7, khu ICU với kiểm soát áp suất dương/âm, và hệ thống lọc HEPA H14 đảm bảo chất lượng không khí đạt tiêu chuẩn y tế quốc tế.</p>',
    ...
    // =============================================
    console.log('\n--- Seeding EVENTS ---');
    await client.query("DELETE FROM events WHERE slug LIKE 'vrc-%'");
    ...
    await client.query(`
      ...
      (
        ...
        'vrc-hvacr-vietnam-2025',
        'VRC tham gia Triển lãm Quốc tế HVACR Vietnam 2025 tại SECC TP.HCM, giới thiệu các giải pháp điện lạnh mới nhất.',
        '<p>VRC tham gia với gian hàng 200m² tại Triển lãm Quốc tế HVACR Vietnam 2025, trưng bày các sản phẩm và giải pháp mới nhất trong lĩnh vực điều hòa không khí, kho lạnh và xử lý không khí.</p>',
      ...
      (
        ...
        'vrc-hoi-thao-tiet-kiem-nang-luong',
        'Hội thảo chuyên đề về các giải pháp tiết kiệm năng lượng trong hệ thống điện lạnh công nghiệp.',
        '<p>VRC phối hợp tổ chức hội thảo chuyên đề "Giải pháp tiết kiệm năng lượng trong hệ thống điện lạnh công nghiệp" tại Khách sạn Rex, TP.HCM. Chương trình gồm các bài trình bày từ chuyên gia trong và ngoài nước.</p>',
        'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=800',
        NOW() + INTERVAL '15 days',
        NOW() + INTERVAL '15 days',
        'Khách sạn Rex, 141 Nguyễn Huệ, Q.1, TP.HCM',
        'VRC & Hiệp hội Cơ điện lạnh Việt Nam',
        'upcoming',
        $2, 0, ARRAY['hội thảo', 'tiết kiệm năng lượng', 'công nghiệp']
      ),
      (
        'Khóa đào tạo Kỹ thuật viên HVAC nâng cao',
        'vrc-dao-tao-ky-thuat-vien-hvac',
        'Khóa đào tạo chuyên sâu dành cho kỹ thuật viên HVAC về vận hành và bảo trì hệ thống Chiller, VRV/VRF.',
        '<p>VRC tổ chức khóa đào tạo nâng cao dành cho kỹ thuật viên ngành HVAC với nội dung: Vận hành hệ thống Chiller, Bảo trì hệ thống VRV/VRF, Xử lý sự cố và tối ưu hóa hiệu suất. Giảng viên là các chuyên gia hàng đầu của VRC.</p>',
        'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=800',
        NOW() - INTERVAL '10 days',
        NOW() - INTERVAL '8 days',
        'Trụ sở VRC, 123 Nguyễn Văn Linh, Q.7, TP.HCM',
        'VRC Academy',
        'past',
